...
<template>
  <div class="pl-10 flex">
    <div
      v-if="!isEditing"
      class="w-64 h-full rounded-lg bg-gray-600 my-2 p-4"
    >
    ...
    <!-- TODO: Zmienić by zamiast user.id 2, był to user po prostu zalogowany -->
    <div
      v-if="users.find((user) => user.id === 2)?.canEdit"
      class="mr-10 p-2 w-min"
    >
      <UButton
        class="mr-2 mb-2"
        color="gray"
